...
/**
 * @covers \PayonePayment\Payone\RequestParameter\Builder\PayolutionInvoicing\PreAuthorizeRequestParameterBuilder
 */
class PreAuthorizeRequestParameterBuilderTest extends TestCase
{
    ...
    public function testItAddsCorrectPreAuthorizeParametersForCompanyByBillingAddress(): void
    {
    ...
    public function testItAddsCorrectPreAuthorizeParametersForCompanyByOrderCustomer(): void
    {
        $this->setPayoneConfig(
            $this->getContainer(),
            ConfigInstaller::CONFIG_FIELD_PAYOLUTION_INVOICING_TRANSFER_COMPANY_DATA,
