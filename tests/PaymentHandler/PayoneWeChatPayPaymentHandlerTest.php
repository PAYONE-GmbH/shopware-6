...
/**
 * @covers \PayonePayment\PaymentHandler\PayoneWeChatPayPaymentHandler
 */
class PayoneWeChatPayPaymentHandlerTest extends TestCase
{
    ...
    public function testItPerformsPaymentWithAuthorizationAndSavesCorrectTransactionData(): void
    {
        ...
        $paymentTransaction = $this->getPaymentTransaction(
            ...
            PayoneWeChatPayPaymentHandler::class
        );
    ...
    ): PayoneWeChatPayPaymentHandler {
        return new PayoneWeChatPayPaymentHandler(
