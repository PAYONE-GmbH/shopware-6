...
class DefaultPaymentFilterServiceTest extends TestCase
{
    ...
    public function testCurrency(): void
    {
        ...
        $result = $filterService->filterPaymentMethods($methodCollection, 'CHF', $billingAddress, $shippingAddress);
        ...
        $filterService = new DefaultPaymentFilterService(PaymentHandlerMock::class, ['DE'], null, ['EUR']);
        $result = $filterService->filterPaymentMethods($methodCollection, 'EUR', $billingAddress, $shippingAddress);
