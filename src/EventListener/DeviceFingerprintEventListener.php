...
class DeviceFingerprintEventListener implements EventSubscriberInterface
{
    ...
    {
        return [
            CheckoutConfirmPageLoadedEvent::class  => 'addDeviceFingerprintData',
            AccountEditOrderPageLoadedEvent::class => 'addDeviceFingerprintData',
        ];
    }

    public function addDeviceFingerprintData(
