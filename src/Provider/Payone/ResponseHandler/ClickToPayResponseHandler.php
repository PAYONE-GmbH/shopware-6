...
class ClickToPayResponseHandler implements ResponseHandlerInterface
{
    ...
    public function handle(
        ...
        $savedPseudoCardPan = $dataBag->get(ClickToPayRequestParamEnum::SAVED_PSEUDO_CARD_PAN->value);
        ...
        $cardHolder = $dataBag->get(ClickToPayRequestParamEnum::CARD_HOLDER->value);

        if (empty($savedPseudoCardPan) && $cardInputMode !== 'clickToPay' && $cardInputMode !== 'register') {
            $truncatedCardPan = $dataBag->get(ClickToPayRequestParamEnum::TRUNCATED_CARD_PAN->value);
            $cardExpireDate   = $dataBag->get(ClickToPayRequestParamEnum::CARD_EXPIRE_DATE->value);
            $pseudoCardPan    = $dataBag->get(ClickToPayRequestParamEnum::PSEUDO_CARD_PAN->value);
            $cardType         = $dataBag->get(ClickToPayRequestParamEnum::CARD_TYPE->value);
            $saveCreditCard   = 'on' === $dataBag->get(ClickToPayRequestParamEnum::SAVE_CREDIT_CARD->value);
