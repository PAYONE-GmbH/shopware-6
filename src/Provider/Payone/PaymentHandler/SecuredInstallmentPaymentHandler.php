...
use PayonePayment\Provider\Payone\ResponseHandler\SecuredInstallmentResponseHandler;
...
class SecuredInstallmentPaymentHandler extends AbstractPaymentHandler implements DeviceFingerprintAwareInterface
{
    ...
    public function __construct(
        ...
        SecuredInstallmentResponseHandler $responseHandler,
