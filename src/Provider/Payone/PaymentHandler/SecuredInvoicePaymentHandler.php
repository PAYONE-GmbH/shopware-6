...
use PayonePayment\Provider\Payone\ResponseHandler\SecuredInvoiceResponseHandler;
...
class SecuredInvoicePaymentHandler extends AbstractPaymentHandler implements DeviceFingerprintAwareInterface
{
    ...
    public function __construct(
        ...
        SecuredInvoiceResponseHandler $responseHandler,
    ...
    {
        return SecuredInvoicePaymentMethod::getConfigurationPrefix();
    }
    ...
    {
        return SecuredInvoicePaymentMethod::getId();
    }
}
