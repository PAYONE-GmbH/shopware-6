...
use PayonePayment\Provider\Klarna\PaymentMethod\InstallmentPaymentMethod;
use PayonePayment\Provider\Klarna\ResponseHandler\FinancingTypeAwareInterface;
use PayonePayment\Provider\Klarna\ResponseHandler\InstallmentResponseHandler;
...
class InstallmentPaymentHandler extends AbstractPaymentHandler implements FinancingTypeAwareInterface
{
