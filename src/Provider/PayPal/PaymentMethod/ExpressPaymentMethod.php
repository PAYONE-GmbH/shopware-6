...
class ExpressPaymentMethod extends AbstractPaymentMethod implements
    ExpressCheckoutPaymentMethodAwareInterface
{
    use ExpressCheckoutPaymentMethodTrait;

    final public const UUID = '5ddf648859a84396a98c97a1a92c107f';

    final public const TECHNICAL_NAME = 'payone_paypal_express';

    final public const CONFIGURATION_PREFIX = 'paypalExpress';
