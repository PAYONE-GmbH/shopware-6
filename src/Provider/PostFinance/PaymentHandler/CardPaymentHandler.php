...
use PayonePayment\Provider\PostFinance\PaymentMethod\CardPaymentMethod;
use PayonePayment\Provider\PostFinance\ResponseHandler\CardResponseHandler;
...
class CardPaymentHandler extends AbstractPaymentHandler
{
    ...
    {
        return CardPaymentMethod::getConfigurationPrefix();
    }
    ...
    {
        return CardPaymentMethod::getId();
    }
}
