...
namespace PayonePayment\Provider\PostFinance\PaymentHandler;
...
use PayonePayment\Provider\PostFinance\PaymentMethod\WalletPaymentMethod;
use PayonePayment\Provider\PostFinance\ResponseHandler\WalletResponseHandler;
...
class WalletPaymentHandler extends AbstractPaymentHandler
{
    ...
    public function __construct(
        ...
        WalletResponseHandler $responseHandler,
    ...
    {
        return WalletPaymentMethod::getConfigurationPrefix();
    }
    ...
    {
        return WalletPaymentMethod::getId();
    }
}
