...
readonly class AuthorizeRequestParameterEnricher implements RequestParameterEnricherInterface
{
    ...
    public function enrich(AbstractRequestDto $arguments): array
    {
        ...
        $parameters = [
            ...
            'financingtype'                     => 'PYS',
            'add_paydata[installment_duration]' => (int) $arguments->requestData->get('payolutionInstallmentDuration'),
            'iban'                              => $arguments->requestData->get('payolutionIban'),
            'bic'                               => $arguments->requestData->get('payolutionBic'),
            'bankaccountholder'                 => $arguments->requestData->get('payolutionAccountOwner'),
        ];
