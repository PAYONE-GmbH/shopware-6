...
namespace PayonePayment\Provider\Eps\DependencyInjection\Compiler;
    ...
    MergeRequestParameterEnricherCompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container): void
    {
        $this->merge($container,
            'payone.request_enricher_chain.pay.eps.standard',
            'payone.request_enricher.pay.eps.standard',
        );
    }
}
