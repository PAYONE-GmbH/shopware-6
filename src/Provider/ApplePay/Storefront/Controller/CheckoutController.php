...
namespace PayonePayment\Provider\ApplePay\Storefront\Controller;

use PayonePayment\Provider\ApplePay\StoreApi\Route\AbstractApplePayRoute;
...
readonly class CheckoutController
{
    public function __construct(
        private AbstractApplePayRoute $route,
    ) {
    }

    #[Route(
        path: 'validate-merchant',
        name: 'frontend.payone.apple-pay.validate-merchant',
        methods: [ 'POST' ],
    )]
    ...
    #[Route(
        ...
        name: 'frontend.payone.apple-pay.process-payment',
        methods: [ 'POST' ],
    )]
