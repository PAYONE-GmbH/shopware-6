...
namespace PayonePayment\Provider\Wero\DependencyInjection\Compiler;
    ...
    MergeRequestParameterEnricherCompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container): void
    {
        $this->merge($container,
            'payone.request_enricher_chain.pay.wero.standard',
            'payone.request_enricher.pay.wero.standard',
        );
    }
}
