...
readonly class CustomerDataPersistorService
{
    ...
    protected function saveCustomerData(CustomerEntity $customer, RequestDataBag $dataBag, Context $context): void
    {
        ...
        if (
            ...
            && $birthday->getTimestamp() !== $customer->getBirthday()?->getTimestamp()
        ) {
    ...
    private function getCustomer(OrderEntity $order, Context $context): CustomerEntity|null
    {
    ...
    private function getCustomerAddress(CustomerEntity $customer, Context $context): CustomerAddressEntity|null
    {
