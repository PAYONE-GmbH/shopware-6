...
use PayonePayment\Payone\Request\Invoice\InvoiceAuthorizeRequestFactory;
use PayonePayment\Payone\Request\Invoice\InvoicePreAuthorizeRequestFactory;
...
class PayoneInvoicePaymentHandler extends AbstractPayonePaymentHandler implements SynchronousPaymentHandlerInterface
{
    /** @var InvoicePreAuthorizeRequestFactory */
    private $preAuthRequestFactory;

    /** @var InvoiceAuthorizeRequestFactory */
    ...
    public function __construct(
        ...
        InvoicePreAuthorizeRequestFactory $preAuthRequestFactory,
        InvoiceAuthorizeRequestFactory $authRequestFactory,
