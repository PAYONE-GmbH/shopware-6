...
abstract class AbstractPaypalAuthorizeRequestFactory extends AbstractRequestFactory
{
    /** @var AbstractPaypalAuthorizeRequest */
    ...
    public function __construct(
        AbstractPaypalAuthorizeRequest $paypalRequest,
