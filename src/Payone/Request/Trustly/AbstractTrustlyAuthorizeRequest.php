...
abstract class AbstractTrustlyAuthorizeRequest
{
    /** @var RedirectHandler */
    ...
    public function getRequestParameters(PaymentTransaction $transaction, Context $context, string $referenceNumber, string $iban): array
    {
