...
export default {
  ...
  computed: {
    ...
    orderActionLogColumns() {
      return [
        { property: 'transactionId', label: this.$tc('sw-order.payone-payment.orderActionLog.columnTitleTransactionId') },
        { property: 'request', label: this.$tc('sw-order.payone-payment.orderActionLog.columnTitleRequest') },
        { property: 'response', label: this.$tc('sw-order.payone-payment.orderActionLog.columnTitleResponse') },
        { property: 'amount', label: this.$tc('sw-order.payone-payment.orderActionLog.columnTitleAmount') },
        { property: 'requestDateTime', label: this.$tc('sw-order.payone-payment.orderActionLog.columnTitleRequestDateTime') },
      ];
    },
    keyValueColumns() {
      return [
